      ...
      <div class="board">
        <div class="header-row">
          ...
          ${this._persons.map((e,t)=>{const i=e.person?this.hass.states[e.person]:void 0,s=this._isOff(t);return W`
              ...
              >
                ${this._avatar(e,t)}
                ${s?K:W`<div class="pname">${this._personName(e,t)}</div>
                        <div class="pstatus">
