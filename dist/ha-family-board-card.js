      ...
      <div class="board">
        ...
        <div class="body" style="height:${a}px">
          ...
          ${this._persons.map((a,n)=>{const o=this._personCanCreate(a),l=this._dayLayout(e,n);return j`
              ...
              >
                ${this._bgFor(e,n).filter(e=>e.endMin>r&&e.startMin<s).map(e=>{const i=(e.startMin-r)*t,s=Math.max((e.endMin-e.startMin)*t-3,16),a=this._eventColor(e),n=this._isTentative(e);return j`
                      <div
                        ...
                        style="top:${i+1.5}px;height:${s}px;
                               ...
                               background:linear-gradient(135deg, ${a}22, ${a}12)"
