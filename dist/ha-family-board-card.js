                ...
                ${l.events.filter(e=>e.endMin>r&&e.startMin<a).map(e=>{const i=(e.startMin-r)*t,a=Math.max((e.endMin-e.startMin)*t-3,16),s=this._eventColor(e),n=e.col/e.cols*100,o=100/e.cols,l=this._isTentative(e);return j`
                      <div
                        ...
                        style="top:${i+1.5}px;height:${a}px;
                               ...
                               background:linear-gradient(135deg, ${s}55, ${s}3a)"
