    ...
    `}_renderTimeline(){const e=this._visibleDays.includes(this._day)?this._day:this._visibleDays[0],{startMin:t,endMin:i}=this._dayWindow(e),r=Math.min(240,Math.max(48,Number(this._config.hour_width)||96)),s=r/60,a=(i-t)*s,n=De(this.hass,"long",this._firstDayJs),o=[];for(let e=t/60;e<=i/60;e++)o.push(e);const l=new Date,d=60*l.getHours()+l.getMinutes(),c=!1!==this._config.show_now_line&&this._isRealToday(e)&&d>=t&&d<=i;return j`
      ...
      <div class="tlwrap">
        <div class="tlgrid" style="min-width:calc(var(--fb-tl-label, 150px) + ${a}px)">
          ...
          ${this._persons.map((n,o)=>{const l=this._isOff(o),d=l?[]:this._events.filter(t=>t.day===e&&t.personIdx===o),c=fe(d),h=c.length?Math.max(...c.map(e=>e.cols)):1,p=this._personCanCreate(n),_=n.person?this.hass.states[n.person]:void 0;return j`
